...
func (s *SQLStore) MediaMarker(ctx context.Context) model.MediaMarkerRepository {
	return NewMediaMarkerRepository(ctx, s.getDBXBuilder())
}
...
func (s *SQLStore) Resource(ctx context.Context, m any) model.ResourceRepository {
	...
	case model.MediaMarker:
		return s.MediaMarker(ctx).(model.ResourceRepository)
	case model.Share:
